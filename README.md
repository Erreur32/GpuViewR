...
- 🛰️ **Multi-host**, one hub aggregates N machines via lightweight WS agents
...
<details>
<summary><h2 style="display:inline">⚙️ Configuration</h2> <sub>(click to expand)</sub></summary>
...
<details>
<summary><h2 style="display:inline">🛰️ Add a remote host</h2> <sub>(click to expand)</sub></summary>
...
<details>
<summary><h2 style="display:inline">🏗️ Architecture</h2> <sub>(click to expand)</sub></summary>
