...
// Build a Theme entry. The repeated `mode + tokens: { ... }` shape used to
// be inlined per theme, which Sonar flagged as duplicated lines. Centralising
// the construction keeps each theme to its actual differing palette plus a
...
export const THEMES: Theme[] = [
  makeTheme('midnight', 'Midnight', 'dark', {
    bg: '#0a1020',
    bg2: '#0e1830',
    // Cards lifted off the gradient: more opaque + a touch brighter than
    // the page so they read as elevated surfaces, not flat overlays.
    surface: 'rgba(22, 32, 58, 0.88)',
    surfaceAlt: 'rgba(40, 54, 82, 0.70)',
  ...
  makeTheme('graphite', 'Graphite', 'dark', {
    bg: '#0d0d10',
    bg2: '#16161b',
    surface: 'rgba(34, 34, 40, 0.90)',
    surfaceAlt: 'rgba(54, 54, 62, 0.72)',
